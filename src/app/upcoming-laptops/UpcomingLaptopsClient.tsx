...
const UPCOMING_LAPTOPS: UpcomingLaptop[] = [
  // ── LAUNCHING SOON (May-June 2026) ──
  {
    ...
    keySpecs: ['Snapdragon X Elite', 'Qualcomm Adreno GPU', '14" 2.8K OLED', 'Ceraluminum 980g'],
    highlight: 'Lightest AI Ultrabook',
    useCase: 'Office',
    articleSlug: 'upcoming-asus-zenbook-a14-2026-05-07',
  },
  {
    id: 'asus-zenbook-s14-2026',
    name: 'ASUS Zenbook S14 (2026)',
    brand: 'ASUS',
    expectedPrice: '₹1,19,999 से शुरू',
    expectedLaunch: 'May 2026',
    launchMonth: 'May 2026',
    status: 'launching-soon',
    keySpecs: ['Intel Arrow Lake Ultra 7', 'Intel Arc iGPU', '14" 3K OLED 120Hz', '72Whr Battery'],
    highlight: 'Premium Ultrabook',
    useCase: 'Office',
    articleSlug: 'upcoming-asus-zenbook-s14-2026-05-07',
  },
  {
    id: 'asus-zenbook-duo-2026',
    ...
    launchMonth: 'May 2026',
    status: 'launching-soon',
    keySpecs: ['Intel Arrow Lake Ultra 9', 'Intel Arc GPU', 'Dual 14" OLED Screens', '75Whr Battery'],
    highlight: 'Dual-Screen Innovation',
    useCase: 'Creators',
    articleSlug: 'upcoming-asus-zenbook-duo-2026-05-07',
  },
  {
  ...
  },
  {
    ...
    launchMonth: 'June 2026',
    status: 'confirmed',
    keySpecs: ['Intel Arrow Lake Ultra 7', 'Intel Arc GPU', '14" 2.8K OLED Touch', '2-in-1 Convertible'],
    highlight: 'Best 2-in-1 Laptop',
    useCase: 'Creators',
    articleSlug: 'upcoming-hp-omnibook-ultra-flip-2026-05-07',
  },
  {
  ...
  },
  {
    ...
    name: 'Acer Nitro V 16 (2026)',
    brand: 'Acer',
    expectedPrice: '₹74,999 से शुरू',
    expectedLaunch: 'July 2026',
    launchMonth: 'July 2026',
    status: 'confirmed',
    keySpecs: ['AMD Ryzen 7 8845HS', 'RTX 5060 8GB', '16" FHD+ 165Hz', '16GB DDR5'],
    highlight: 'Budget Gaming Under ₹75K',
    useCase: 'Gaming',
    articleSlug: 'upcoming-acer-nitro-v-16-2026-05-07',
  },
  // ── RUMORED (August-October 2026) ──
  {
    id: 'dell-xps-16-2026',
  ...
  },
  {
    ...
    launchMonth: 'October 2026',
    status: 'rumored',
    keySpecs: ['Snapdragon X Elite', 'Qualcomm Adreno GPU', '13" OLED 120Hz', 'Copilot+ PC'],
    highlight: 'Best Windows Tablet',
    useCase: 'Office',
    articleSlug: 'upcoming-microsoft-surface-pro-11-2026-05-07',
  },
];
