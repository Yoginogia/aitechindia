    ...
    return (
        <article className="container mx-auto px-4 md:px-8 max-w-4xl py-12 md:py-20">
            <div className="mb-10">
                ...
                <div className="flex items-start gap-4 py-5 px-6 mt-8 mb-8 border border-border/40 rounded-2xl bg-secondary/10">
                    <div className="w-10 h-10 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center shrink-0">
                        <svg className="w-5 h-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 12h6m-6-4h6"/></svg>
                    </div>
                    <div className="flex flex-col">
                        <span className="font-bold text-foreground text-base">AITechNews Editorial Desk</span>
                        <p className="text-sm text-muted-foreground leading-relaxed mt-1">
                            AITechNews Editorial Desk dwara verified sources ke aadhar par likha gaya hai. Content ka maqsad sirf informational hai.
                        </p>
                    </div>
                </div>
            </div>
