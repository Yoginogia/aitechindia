...
const STORIES = [
    {
        slug: 'meta-ai-chips',
        title: 'Meta Ne Launch Kiye 4 Naye AI Chips!',
        subtitle: 'Kya Nvidia ka dominance khatam hoga?',
        category: 'AI News',
    ...
    },
    {
        ...
        title: 'iPhone 18 SE: ₹48,900 mein AI Phone?',
        subtitle: 'Leaked specs ne internet hila diya!',
        category: 'Gadgets',
    ...
    {
        slug: 'humanitys-last-exam-ai',
        title: "Humanity's Last Exam — Kya AI Pass Kar Payega?",
        subtitle: '1000 experts ne banaya duniya ka mushkil test',
