...
const UPCOMING_PHONES: UpcomingPhone[] = [
  ...
  },
  {
    ...
    launchMonth: 'May 2026',
    status: 'launching-soon',
    keySpecs: ['Dimensity 9300+', 'Leica 50MP Camera', '5500mAh Battery', '67W Turbo Charge'],
    highlight: 'Value Flagship',
    articleSlug: 'upcoming-xiaomi-17t-2026-05-07',
  },
  {
    ...
    launchMonth: 'May 2026',
    status: 'launching-soon',
    keySpecs: ['Dimensity 8350', '108MP Camera', '6000mAh Battery', 'JBL Dual Speakers'],
    highlight: 'Budget Gaming Phone',
    articleSlug: 'upcoming-infinix-gt-50-pro-2026-05-07',
  },
  {
  ...
  },
  {
    ...
    brand: 'Lava',
    expectedPrice: '₹9,999 से शुरू',
    expectedLaunch: 'June 2026',
    launchMonth: 'June 2026',
    status: 'launching-soon',
    keySpecs: ['MediaTek Dimensity 6300', '50MP Dual Camera', '5000mAh Battery', 'Clean Android 16'],
    highlight: 'Budget 5G Phone',
    articleSlug: 'upcoming-lava-bold-n2-5g-2026-06-02',
  },
  {
    id: 'motorola-edge-70-pro-plus',
    name: 'Motorola Edge 70 Pro+',
    brand: 'Motorola',
    expectedPrice: '₹49,999 से शुरू',
    expectedLaunch: 'June 2026',
    launchMonth: 'June 2026',
    status: 'launching-soon',
    keySpecs: ['Dimensity 8500 Extreme', '6.8" 144Hz AMOLED', '5200 nits Peak Brightness', '50MP Triple OIS'],
    highlight: 'Premium Flagship',
    articleSlug: 'upcoming-motorola-edge-70-pro-plus-2026-06-02',
  },
  // ── CONFIRMED (June-July 2026) ──
   {
    ...
    brand: 'Xiaomi',
    expectedPrice: '₹23,999 से शुरू',
    expectedLaunch: 'June 2026',
    launchMonth: 'June 2026',
    status: 'confirmed',
    keySpecs: ['Snapdragon 8s Gen 4', '50MP Sony Camera', '5500mAh Battery', '100W Fast Charge'],
    highlight: '100W Turbo Performance',
    articleSlug: 'upcoming-xiaomi-redmi-turbo-5-2026-06-02',
  },
 {
    id: 'oneplus-14',
    name: 'OnePlus 14',
  ...
  },
  {
    ...
    launchMonth: 'June 2026',
    status: 'confirmed',
    keySpecs: ['Exynos 2500', '50MP OIS Camera', '4700mAh Battery', 'Galaxy AI Features'],
    highlight: 'Fan Edition Flagship',
    articleSlug: 'upcoming-samsung-galaxy-s25-fe-2026-05-07',
  },
  {
    id: 'cmf-phone-3',
    name: 'CMF Phone 3',
    brand: 'CMF',
    expectedPrice: '₹16,999 से शुरू',
    expectedLaunch: 'June 2026',
    launchMonth: 'June 2026',
    status: 'confirmed',
  ...
  },
  {
    ...
    brand: 'Honor',
    expectedPrice: '₹44,999 से शुरू',
    expectedLaunch: 'August 2026',
    launchMonth: 'August 2026',
    status: 'rumored',
    keySpecs: ['Snapdragon 8 Elite', '200MP Periscope Camera', '5800mAh Battery', 'MagicOS 10'],
    highlight: 'AI Photography King',
    articleSlug: 'upcoming-honor-magic-8-pro-2026-05-07',
  },
  {
    id: 'iphone-18-pro',
    name: 'iPhone 18 Pro',
    brand: 'Apple',
    expectedPrice: '₹1,34,900 से शुरू',
  ...
  },
  {
    ...
    name: 'iPhone 18 Air',
    brand: 'Apple',
    expectedPrice: '₹89,900 से शुरू',
    expectedLaunch: 'September 2026',
    launchMonth: 'September 2026',
    status: 'rumored',
    keySpecs: ['A20 Chip', '48MP Single Camera', '5.9mm Ultra-Thin', 'eSIM Only'],
    highlight: 'Thinnest iPhone Ever',
    articleSlug: 'upcoming-iphone-18-air-2026-05-07',
  },
  {
    id: 'redmi-note-16-pro-plus',
    name: 'Redmi Note 16 Pro+',
    brand: 'Xiaomi',
    expectedPrice: '₹22,999 से शुरू',
    expectedLaunch: 'September 2026',
    launchMonth: 'September 2026',
    status: 'rumored',
