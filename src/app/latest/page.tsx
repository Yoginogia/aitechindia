...
export const metadata = {
    title: 'Latest News | AITechIndia',
    description: 'AITechIndia par AI aur Technology ki sabse taaza khabrein aur articles.',
};
  ...
  return (
    <div className="flex flex-col min-h-screen bg-grid">
      <section className="relative overflow-hidden pt-12 pb-6">
        <div className="absolute top-0 right-10 w-72 h-72 bg-primary/10 rounded-full blur-[100px] pointer-events-none"></div>
        <div className="container mx-auto px-4 md:px-8 max-w-7xl relative z-10">
          <div className="flex items-center justify-between pb-4 border-b border-border/30">
            <div>
              ...
              <p className="text-muted-foreground text-sm md:text-base">Tech aur AI ki duniya ki sabse taaza jankariyan.</p>
            </div>
