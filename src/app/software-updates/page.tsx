...
export default function SoftwareUpdatesPage() {
  ...
  const softwarePosts = allPosts.filter(post => post.category === 'Software Updates');
                   ...
                   >
                     ...
                     <div className="p-5 space-y-3 flex-1 flex flex-col">
                       <div className="flex items-center gap-2 text-xs text-muted-foreground">
                         <span className="font-semibold px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-400">Software Updates</span>
                         <span>•</span>
