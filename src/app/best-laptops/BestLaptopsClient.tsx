...
const ALL_LAPTOPS: Laptop[] = [
    ...
    // OFFICE / BUSINESS
    {
        id: 'hp-omnibook-5-oled',
        name: 'HP OmniBook 5 OLED (Snapdragon)',
        brand: 'HP',
        category: 'office',
        price: 75990,
        amazonUrl: 'https://www.amazon.in/s?k=hp+omnibook+5+oled&tag=aitechnews-21',
        flipkartUrl: 'https://www.flipkart.com/search?q=hp+omnibook+5+oled',
        rating: 4.8,
        specs: {
            processor: 'Snapdragon X Elite (ARM Architecture)',
            ram: '16GB LPDDR5x',
            storage: '512GB PCIe Gen4 SSD',
            display: '14" 2.8K OLED, 120Hz, 400 nits, HDR',
            graphics: 'Adreno Premium GPU',
            battery: '34 Hours Video Playback',
            os: 'Windows 11 Home (ARM)',
        },
        tags: ['34Hr Battery', 'Snapdragon X', 'OLED'],
        pros: ['अविश्वसनीय 34 घंटे की बैटरी लाइफ!', 'बहुत ही हल्का (Ultra-portable) और साइलेंट', 'OLED स्क्रीन पर कलर्स बहुत शानदार हैं'],
        cons: ['कुछ पुरानी x86 Apps ARM पर धीमी चल सकती हैं', 'हैवी गेमिंग के लिए बिलकुल नहीं है'],
        verdict: 'बिजनेस ट्रैवलर्स और स्टूडेंट्स जिन्हें चार्जर घर छोड़ कर जाना पसंद है, उनके लिए यह 2026 का सबसे बेहतरीन लैपटॉप है।',
        ports: ['2x USB4 Type-C', '1x USB-A', '3.5mm Jack']
    },
    {
    ...
    // GAMING
    {
        ...
        category: 'gaming',
        price: 189990,
        amazonUrl: 'https://www.amazon.in/s?k=asus+rog+zephyrus+g16+2026&tag=aitechnews-21',
        flipkartUrl: 'https://www.flipkart.com/search?q=asus+rog+zephyrus+g16',
        rating: 4.9,
        specs: {
            processor: 'Intel Core Ultra 9 185H',
            ram: '32GB LPDDR5X 7467MHz',
            storage: '1TB PCIe 4.0 NVMe M.2 SSD',
            display: '16" 2.5K ROG Nebula OLED, 240Hz, 0.2ms, G-Sync',
            graphics: 'NVIDIA GeForce RTX 5070 8GB GDDR6',
            battery: '90Wh, 200W Fast Charge',
            os: 'Windows 11 Home',
        },
        tags: ['RTX 5070', '240Hz OLED', 'Premium Gaming'],
        pros: ['RTX 5070 (Next-gen) GPU डेस्कटॉप लेवल परफॉरमेंस देता है', 'गेमिंग के लिए 240Hz OLED डिस्प्ले सबसे बेस्ट है', 'एल्युमीनियम CNC चेसिस - दिखने में बेहद स्लीक'],
        cons: ['कीमत बहुत ज़्यादा है (Expensive)', 'अपग्रेड करने के लिए RAM सोल्डर (Soldered) है'],
        verdict: 'प्रोफेशनल गेमर्स और 3D एनिमेटर्स जिन्हें पैसे की चिंता नहीं है और सिर्फ बेस्ट फ्रेम-रेट्स चाहिए।',
        ports: ['1x Thunderbolt 4', '1x Type-C (DP/PD)', '2x USB 3.2', 'HDMI 2.1', 'SD Reader']
    },
    {
    ...
    // CREATOR
    {
        ...
        name: 'Apple MacBook Air 14 (M4 Chip)',
        brand: 'Apple',
        category: 'creator',
        price: 119900,
        amazonUrl: 'https://www.amazon.in/s?k=macbook+air+m4&tag=aitechnews-21',
        flipkartUrl: 'https://www.flipkart.com/search?q=macbook+air+m4',
        rating: 5.0,
        specs: {
            processor: 'Apple M4 chip (10-core CPU, 16-core Next-Gen Neural Engine)',
            ram: '16GB Unified Memory (Base Model)',
            storage: '512GB fast SSD',
            display: '14" Liquid Retina display, 600 nits',
            graphics: '10-core GPU (Hardware-accelerated ray tracing)',
            battery: 'Lithium-Po (Up to 20 hours battery life)',
            os: 'macOS 16 (With Apple Intelligence)',
        },
        tags: ['M4 Power', '16GB Base RAM', 'Apple Intelligence'],
        pros: ['M3 के मुकाबले 25% फास्ट है', 'AI फीचर्स (Apple Intelligence) इन-बिल्ट हैं', 'अब बेस मॉडल 16GB RAM के साथ आता है!'],
        cons: ['स्टोरेज अपग्रेड्स (1TB/2TB) के दाम आसमान छूते हैं', '4K गेमिंग के लिए यह लैपटॉप नहीं है'],
        verdict: 'क्रिएटर्स! यह 2026 की सबसे बेहतरीन मशीन है। 16GB बेस रैम और M4 चिप इसे आने वाले 5-7 सालों के लिए फ्यूचर प्रूफ़ बनाते हैं।',
        ports: ['2x Thunderbolt 4', 'MagSafe 3', '3.5mm Jack']
    },
    {
        id: 'samsung-galaxy-book6-ultra',
        name: 'Samsung Galaxy Book 6 Ultra',
        brand: 'Samsung',
        category: 'creator',
        price: 179999,
        amazonUrl: 'https://www.amazon.in/s?k=samsung+galaxy+book6+ultra&tag=aitechnews-21',
        flipkartUrl: 'https://www.flipkart.com/search?q=samsung+galaxy+book6+ultra',
        rating: 4.8,
        specs: {
            processor: 'Intel Core Ultra 7 (Series 2) AI Processor',
            ram: '32GB LPDDR5x',
            storage: '1TB M.2 PCIe NVMe SSD',
            display: '16" 3K (2880x1800) AMOLED 2X, 120Hz',
            graphics: 'NVIDIA RTX 4070 (Laptop GPU)',
            battery: '76Wh (22 Hours), 140W Type-C Charge',
            os: 'Windows 11 Home + Galaxy AI Integration',
        },
        tags: ['Galaxy AI', '3K AMOLED', 'RTX 4070'],
        pros: ['Dynamic AMOLED 2X डिस्प्ले वीडियो कलर ग्रेडिंग के लिए परफेक्ट है', 'Galaxy S26 Ultra फोन के साथ सीमलेस इकोसिस्टम', 'RTX 4070 इसे 3D रेंडरिंग और ब्लेंडर के लिए मॉन्स्टर बनाता है'],
        cons: ['ट्रैवल के लिए साइज़ में थोड़ा बड़ा है (16-inch footprint)', 'कीमत आम यूज़र के बजट से बहुत बाहर है'],
        verdict: 'अगर आप Windows यूज़र हैं और आपको MacBook Pro जैसी पावर और बैटरी चाहिए, तो Galaxy Book 6 Ultra आपकी मंज़िल है।',
        ports: ['2x Thunderbolt 4', '1x USB-A', 'HDMI 2.1', 'MicroSD']
    },
    {
