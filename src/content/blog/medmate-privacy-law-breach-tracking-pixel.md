...
1. **Meta and Google Pixels:** मेडमेट और मोनाश आईवीएफ की वेबसाइट्स पर मेटा (Meta Pixel) और गूगल एनालिटिक्स के कोड छिपे हुए थे।
2. **Without User Consent:** जब मरीज ऑनलाइन अपॉइंटमेंट बुक कर रहे थे या अपनी बीमारियों की डिटेल्स भर रहे थे, तब यह कोड बिना उनकी सहमति के उनके नाम, बीमारी के प्रकार और ईमेल को ट्रैक कर रहा था।
3. **Targeted Advertising:** इस डेटा का इस्तेमाल मरीजों को टारगेटेड विज्ञापन (Targeted Ads) दिखाने के लिए किया गया, जो कि मेडिकल एथिक्स और प्राइवेसी नियमों का गंभीर उल्लंघन है।
...
<!-- [!NOTE] AI Image Prompt: Abstract telehealth screen displaying medical symbols with hidden glowing digital tracking pixel waves radiating outwards, lock symbol breaching, dark cybersecurity visualization, premium style, no logos, no human faces. -->

<!--
## Web Story Brief
- Vehicle/Technology Name: Medmate Tracking Pixel Breach
- Biggest Highlight: Australia's Privacy Commissioner rules against Medmate and Monash IVF for using Meta/Google pixels to harvest sensitive patient data.
- Range/Battery Feature: Pixel-based tracking of medical consultation queries, prescriptions, and IVF appointments without user consent.
- Price or Availability: Privacy ruling issued formally on June 24, 2026.
- India Impact: Serves as a major warning to Indian health platforms under the DPDP Act, where processing health data without consent carries up to ₹250 crore fines.
-->
