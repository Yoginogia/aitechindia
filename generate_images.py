...
articles = [
    {
        "file": "src/content/blog/ai-gemini-8-tips-organizing-life-space-hindi-2026-04-26.md",
        "prompt": "futuristic AI holographic interface showing organizing tips for living space, bright, glowing blue and purple, hyperrealistic, 8k",
        "name": "ai_gemini_organizing"
    },
    {
...
for item in articles:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Failed to fetch {item['name']}: {response.status_code}")
